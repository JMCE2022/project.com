...
class DashboardController extends Controller
{
    ...
    {
        $ageCount0 = Children::where('sex', '=', 'M')->where('age', '=', 0)->count();
        $ageCount1 = Children::where('sex', '=', 'M')->where('age', '>=', 1)->where('age', '<=', 5)->count();
        $ageCount2 = Children::where('sex', '=', 'M')->where('age', '>=', 6)->where('age', '<=', 10)->count();
        $ageCount3 = Children::where('sex', '=', 'M')->where('age', '>=', 11)->where('age', '<=', 15)->count();
        $ageCount4 = Children::where('sex', '=', 'M')->where('age', '>=', 16)->where('age', '<=', 17)->count();
        $ageCount5 = Children::where('sex', '=', 'M')->where('age', '>=', 18)->count();
        ...
        $ageCount00 = Children::where('sex', '=', 'F')->where('age', '=', 0)->count();
        $ageCount11 = Children::where('sex', '=', 'F')->where('age', '>=', 1)->where('age', '<=', 5)->count();
        $ageCount22 = Children::where('sex', '=', 'F')->where('age', '>=', 6)->where('age', '<=', 10)->count();
        $ageCount33 = Children::where('sex', '=', 'F')->where('age', '>=', 11)->where('age', '<=', 15)->count();
        $ageCount44 = Children::where('sex', '=', 'F')->where('age', '>=', 16)->where('age', '<=', 17)->count();
        $ageCount55 = Children::where('sex', '=', 'F')->where('age', '>=', 18)->count();
        ...
        $dischargeCount11 = Children::where('is_deleted', '=', 1)->where('sex', '=', 'M')->count();
        $dischargeCount22 = Children::where('is_deleted', '=', 1)->where('sex', '=', 'F')->count();
       
        $dischargeLabels = ['Male', 'Female'];
        $dischargeCounts = [$dischargeCount11, $dischargeCount22];

        $clientCount11 = Children::all()->where('sex', '=', 'M')->count();
        $clientCount22 = Children::all()->where('sex', '=', 'F')->count();
       
        $clientLabels = ['Male', 'Female'];
        $clientCounts = [$clientCount11, $clientCount22];

        $childrenCount = Children::all()->count();
        $maleCount = Children::where('Sex', 'M')->count();
        $femaleCount = Children::where('Sex', 'F')->count();
