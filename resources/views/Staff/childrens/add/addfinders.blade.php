            ...
            @include('layouts.addpage')
                ...
                <div class="col-sm-12 col-xl-12">
                    ...
                    <div class="">
                        ...
                        <input rows="1" name="finder_problem_presented" class="custom-input bg-white my-1 me-1" style="height:100px;">
                    </div>
                    ...
                    <div class="">
                        ...
                        <input name="finder_background_information" class="custom-input bg-white my-1 me-1 text-dark" style="height:100px;" >
                    </div>
