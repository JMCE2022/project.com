        ...
        <div class="container bg-white rounded">
            ...
            @include('layouts.addpage')
                ...
                <div class="col-sm-12 col-xl-12">
                    ...
                    <div class="form-check mr-sm-2">
                        <input value="Yes"
                            name="habit_primary_complex"
                          type="checkbox"
                          class="form-check-input"
                        />
                        <label
                          class="form-check-label mb-0"
                          >Primary Complex</label
                        >
                      </div>
                    ...
                    <div class=" mb-3">
                        ...
                        <input type="text" name="habit_other_specify" class="custom-input bg-white" style="height:100px;">
                    </div>
                    ...
                    <div class=" mb-3">
                        ...
                        <input type="text" name="habit_motor_development" class="custom-input bg-white" style="height:100px;">
                    </div>
                    ...
                    <div class=" mb-3">
                        ...
                        <input type="text" name="habit_toilet_training" class="custom-input bg-white" style="height:100px;">
                    </div>
