        ...
        <div class="bg-white rounded h-100 p-4">
            ...
            <div class="d-flex align-items-center justify-content-between">
                ...
                <div>
                    ...
                    <a class="text-dark me-2 rounded border-bottom border-danger" href="{{url('Admin/Listarchivechildren')}}"><i
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <a href="{{ url('Admin/Listchildrens/Preview/'.$children->id) }}"><i class="fas fa-eye" style="color: #000000;"></i></a>
